            ...
            <Row>
              <Col lg='6' md='6'>
                <div className="hero_content">
                  ...
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsum natus eius eveniet magni excepturi molestiae sit eaque. </p>
        ...
        <section className='pt-0'>
          <Container>
            <Row>
              ...
              {
                hotPizza.map(item => (
                  <Col lg='3' md='4' key={item.id} className=' d-flex justify-content-center'>
                    <ProductCard item={item}></ProductCard>
                  </Col>
                ))
              }
